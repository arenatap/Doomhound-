...
import { getContract, deployContract } from "viem";
...
async function main() {
  ...
  const initialSigner = "0xF1a5ac3Fae5e17Fb1B75f7c51C6667471c1dEeBa" as `0x${string}`;
  ...
  if (receipt.status === "success") {
    ...
    console.log("===========================================");
    console.log("\nSnowtrace URL: https://snowtrace.io/address/" + contractAddress);
  } else {

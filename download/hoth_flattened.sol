...
// File npm/@openzeppelin/contracts@5.6.1/token/ERC721/IERC721.sol
...
// File npm/@openzeppelin/contracts@5.6.1/token/ERC721/extensions/IERC721Metadata.sol
...
// File npm/@openzeppelin/contracts@5.6.1/token/ERC721/IERC721Receiver.sol
...
// File npm/@openzeppelin/contracts@5.6.1/token/ERC721/utils/ERC721Utils.sol
...
// File npm/@openzeppelin/contracts@5.6.1/token/ERC721/ERC721.sol
...
// File npm/@openzeppelin/contracts@5.6.1/token/ERC721/extensions/IERC721Enumerable.sol
...
// File npm/@openzeppelin/contracts@5.6.1/token/ERC721/extensions/ERC721Enumerable.sol
...
// File contracts/DoomhoundNFT.sol
 ...
 *
 * DOOMHOUND NFT Collection - Hounds of the Hell
 * 100 unique hounds on Avalanche C-Chain
 *
 * Features:
 * - Free mint with backend ECDSA signature verification (whitelist)
 * - Paid mint at configurable price (0.69 AVAX default)
 * - Token mint with $DOOMHOUND ERC20 burn (11M tokens)
 * - Reveal mechanic with unrevealed/revealed URI
 * - Max 1 free / 2 paid / 1 token per wallet
 * - Admin functions for airdrops and metadata management
 * - Anti-replay signature protection
 *
 * SECURITY: Owner and Signer are SEPARATE addresses.
 * - Owner: deploys, manages contract (adminMint, withdraw, setSigner, etc.)
 * - Signer: signs whitelist messages (does NOT need to be owner)
 * This ensures the signer key compromise cannot drain contract funds.
 */
...
contract DoomhoundNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    // $DOOMHOUND token contract for token-gated mint
    ...
    // ===== PAID MINT =====
    /**
     * @dev Mint NFTs by paying the mint price.
    ...
    // ===== TOKEN MINT (Burn $DOOMHOUND) =====
    /**
     * @dev Mint an NFT by burning $DOOMHOUND tokens (transfer to BURN_ADDRESS).
     * Requires prior approval of tokenMintPrice tokens to this contract.
    ...
    function mintWithToken(uint256 quantity) external {
        ...
        // Transfer $DOOMHOUND from sender to BURN_ADDRESS (burn)
    ...
    // ===== ADMIN MINT (for airdrops/team/giveaways) =====

        ...
        <div className="space-y-8">
          {steps.map((step, i) => (
            <ScrollReveal key={step.num} delay={i * 0.1}>
              <div
                className="flex items-start gap-6 bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6 hover:border-red-600/50 hover:shadow-[0_0_15px_rgba(220,38,38,0.2)] transition-all duration-300 group cursor-default"
              ...
              >
                ...
                <div className="relative flex-shrink-0">
                  <div
                    className={`w-14 h-14 rounded-full flex items-center justify-center text-2xl font-bold border-2 transition-all duration-300 ${
                  ...
                  {/* Blood drip on hover */}
                  {hoveredStep === step.num && (
                    <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-2 h-6 bg-gradient-to-b from-red-600 to-red-900 rounded-b-full animate-blood-drip" />
                  )}
                </div>

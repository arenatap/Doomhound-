...
const stats = [
  { label: "Total Supply", value: "1,000,000,000 $DOOMHOUND" },
  { label: "Tax", value: "0/0" },
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4">
        <ScrollReveal>
          <div className="text-center mb-16">
            <h2 className="font-creepster text-5xl md:text-7xl text-red-500 animate-glow-red relative inline-block">
              TOKENOMICS
              {/* Blood drip letters effect */}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <ScrollReveal delay={0.1}>
            <div className="flex flex-col items-center">
              ...
              <p className="text-red-400 font-creepster text-2xl mt-4">
                100% Community
              </p>
          ...
          <ScrollReveal delay={0.2}>
            <div className="grid grid-cols-2 gap-4">
              {stats.map((stat, i) => (
                <div
                  key={i}
                  className="bg-[#1a1a1a] border border-red-900/30 rounded-xl p-5 text-center animate-flame-border hover:border-red-600/50 transition-all duration-300"
                >
            ...
            <p className="text-center text-gray-500 mt-6 text-sm italic">
              &quot;Fair launch. No BS. The Doomhound doesn&apos;t play
              favorites.&quot;
            </p>
          </ScrollReveal>
        </div>
